...
const tvly = tavily({ apiKey: process.env.GROQ_API_KEY });
const groq = new Groq({ apiKey: process.env.TAVILY_API_KEY });
...
async function webSearch({query}){
   ...
   const response = await tvly.search(query,{max_result:1});
